                    ...
                    {isUserAdmin && (
                        <Container component="main" maxWidth="sm" style={{ marginTop: '55px', backgroundColor: '#ffffff', padding: '40px', borderRadius: '10px', display: 'flex', justifyContent: 'center', alignItems: 'center', width: '85%' }}>
                            <Grid container spacing={2}>
                                ...
                                <Grid item xs={12}>
                                    <Button variant="contained" onClick={handleSubmit} fullWidth disabled={loading}>{loading ? <CircularProgress size={24} color="info" /> : 'Salvar'}</Button>
                                </Grid>
                                <Grid item xs={12}>
                                    <Button variant="contained" color="error" onClick={() => navigate('/user')} fullWidth>Voltar</Button>
                                </Grid>
                            </Grid>
                        </Container>
                    )}
